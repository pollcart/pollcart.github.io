...
function CB(bg) {
    var url;
    if (bg == 'yourvalue1') {
        url = 'https://res.cloudinary.com/pollcart/image/fetch/q_auto,f_auto/https://pollcart.github.io/images/hero-five.jpg';
        ...
        url = 'https://res.cloudinary.com/pollcart/image/fetch/q_auto,f_auto/https://pollcart.github.io/images/hero-two.jpg';
        document.getElementById('ecard').style.backgroundImage = 'url(' + url + ')';
        ...
        url = 'https://res.cloudinary.com/pollcart/image/fetch/q_auto,f_auto/https://pollcart.github.io/images/hero-three.jpg';
        document.getElementById('ecard').style.backgroundImage = 'url(' + url + ')';
        ...
        url = 'https://res.cloudinary.com/pollcart/image/fetch/q_auto,f_auto/https://pollcart.github.io/images/hero-four.jpg';
        document.getElementById('ecard').style.backgroundImage = 'url(' + url + ')';
