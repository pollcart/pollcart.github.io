...
function CB(bg) {
    var url;
    if (bg == 'yourvalue1') {
        url = 'http://res.cloudinary.com/pollcart/image/fetch/https://pollcart.github.io/images/hero-five.jpg';
        ...
        url = 'http://res.cloudinary.com/pollcart/image/fetch/https://pollcart.github.io/images/hero-two.jpg';
        document.getElementById('ecard').style.backgroundImage = 'url(' + url + ')';
        ...
        url = 'http://res.cloudinary.com/pollcart/image/fetch/https://pollcart.github.io/images/hero-three.jpg';
        document.getElementById('ecard').style.backgroundImage = 'url(' + url + ')';
        ...
        url = 'http://res.cloudinary.com/pollcart/image/fetch/https://pollcart.github.io/images/hero-four.jpg';
        document.getElementById('ecard').style.backgroundImage = 'url(' + url + ')';
